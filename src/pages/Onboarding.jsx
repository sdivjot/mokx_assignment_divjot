...
function Onboarding() {
    return <>
        <div className='flex flex-col items-center justify-evenly bg-[#69235B] h-screen'>
        ...
        <div className='flex flex-row text-lg bg-[#CBCBFF] h-8 w-48 rounded-md text-[#69235B] font-medium justify-center align-center z-10 absolute top-[320px] left-24'>Arya, Vedic AI Guide</div>
    </>
}
